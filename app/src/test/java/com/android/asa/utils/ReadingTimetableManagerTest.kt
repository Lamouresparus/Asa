...
class ReadingTimetableManagerTest {
    ...
    @Test
    fun `verify that generate time table is invoke with the correct params`() {
    ...
    val dayOfTheWeek = arrayListOf(
     ...
     val courses = listOf(CourseDomain("Computer Appreciation", "CPE211", 3, "hmm test", "Mr O", listOf(dayOfTheWeek[0], dayOfTheWeek[1]), listOf(LectureDayDomain())),
